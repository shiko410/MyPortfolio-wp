						...
						<div class="container">
							<div class="row text-center">
								...
								<div class="my-photo col-md-12 col-lg-6" data-aos="fade-up-right" data-aos-duration="1500">
									<!-- Photo -->
									<img src="<?php echo(get_theme_file_uri()); ?>/imgid-photo-2.jpg" alt="プロフィール写真" class="rounded-circle">
									<!-- // Photo -->
							...
							<div class="row">
								...
								<div class="box col-12 pt-0 pb-0 pt-md-3 pb-md-3" data-aos="fade-down" data-aos-duration="2000">
									...
									<div class="icons row p-0 p-md-3">
										<div class="skl-icons col-12 col-md-6 d-flex mx-auto p-0">
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/html5-logo.png" alt="html5">
											</div>
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/css3-logo.png" alt="css3">
											</div>
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/js-logo.png" alt="JavaScript">
											</div>
										</div>
										<div class="skl-icons col-12 col-md-6 d-flex mx-auto p-0">
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/php-color.svg" alt="php">
											</div>
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/MySQL-logo.png" alt="MySQL">
											</div>
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/wordpress-logo.png" alt="WordPress">
											</div>
										</div>
									</div>
									<!-- 2段目 -->
									<div class="icons row p-0 p-md-3">
										<div class="skl-icons col-12 col-md-6 d-flex mx-auto p-0">
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/jquery-logo.png" alt="jQuery">
											</div>
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/laravel-color.svg" alt="laravel">
											</div>
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/sass-color.svg" alt="sass">
											</div>
										</div>
										<div class="skl-icons col-12 col-md-6 d-flex mx-auto p-0">
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/github-logo.png" alt="github">
											</div>
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/adobe-illustrator-cs6.png" alt="illustrator">
											</div>
											<div class="skl-icon rounded-circle bg-white d-flex align-items-center mx-auto">
												<img src="<?php echo(get_theme_file_uri()); ?>/imgicon/adobe-photoshop-cs6.png" alt="photoshop">
											</div>
										</div>
									</div>
								</div>
										...
										<div class="swiper-container">
											...
											<div class="swiper-wrapper">
												...
												<div class="swiper-slide">
													<a href="<?php echo(get_theme_file_uri()); ?>/imgportfolio-1-1.png" class="modal-w">
														<img class="p-img" src="<?php echo(get_theme_file_uri()); ?>/imgportfolio-1.png" alt="portfolio1">
													</a>
												</div>
												<div class="swiper-slide">
													<a href="<?php echo(get_theme_file_uri()); ?>/imgportfolio-2-1.png" class="modal-w">
														<img class="p-img" src="<?php echo(get_theme_file_uri()); ?>/imgportfolio-2.png" alt="portfolio2">
													</a>
												</div>
												<div class="swiper-slide">
													<a href="<?php echo(get_theme_file_uri()); ?>/imgportfolio-2-1.png" class="modal-w">
